...
export const STATIC_CARDS: Card[] = [
  ...
  },
  {
    ...
    merchants: [
      ...
      { store: 'AT&T Wireless', cardOffer: 'Spend $65+, earn $30 back (new customers only)', rakutenPoints: 'up to 15x points' },
      ...
      { store: 'Expedia', cardOffer: 'Prepaid hotels, up to $125 back', rakutenPoints: 'up to 15x points' },
      ...
      { store: 'Brilliant Earth', cardOffer: 'Spend $500+, earn $100 back', rakutenPoints: 'up to 15x points' },
    ],
  },
];
