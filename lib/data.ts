...
export const STATIC_CARDS: Card[] = [
  {
    ...
    merchants: [
      ...
      { store: 'iHerb', cardOffer: '5% cash back', rakutenPoints: '15x points' },
      { store: 'KiwiCo', cardOffer: '10% cash back', rakutenPoints: '15x points' },
      { store: 'Beautyrest', cardOffer: '10% cash back', rakutenPoints: '15x points' },
      { store: 'Tuft & Needle', cardOffer: '10% cash back', rakutenPoints: '15x points' },
  ...
  },
  {
    ...
    merchants: [
      ...
      { store: 'Liquid I.V.', cardOffer: '15% cash back', rakutenPoints: '10x points' },
      { store: 'Musely', cardOffer: '$30 cash back', rakutenPoints: '10x points' },
      { store: 'AG1', cardOffer: '25% cash back', rakutenPoints: '10x points' },
      { store: 'Ancestry', cardOffer: '10% cash back', rakutenPoints: '10x points' },
      { store: 'Pandora Jewelry', cardOffer: '10% cash back', rakutenPoints: '10x points' },
      { store: 'Mattress Firm', cardOffer: '3% cash back', rakutenPoints: 'up to 10x points' },
      { store: 'AARP', cardOffer: '$8 cash back', rakutenPoints: 'up to 3,500 points' },
  ...
  },
  {
    ...
    sheetName: 'Amex',
    merchants: [
      { store: 'Kérastase', cardOffer: 'Spend $200+, earn $20 back', rakutenPoints: '15x points' },
      ...
      { store: 'EyeBuyDirect', cardOffer: 'Spend $75+, earn $20 back', rakutenPoints: 'up to 15x points' },
      { store: 'Under Armour', cardOffer: 'Spend $50+, earn $10 back', rakutenPoints: '15x points' },
